...
public class ConstraintWBasedV2 {
	...
	public ConstraintWBasedV2(Domain d1, Domain d2, ExperimentParams par) {
		this.d1 = d1;
		this.d2 = d2;
		parseParams(par);
	...
	public void Start() {
		...
		while (t < maximum_number_iterations) {
			...
			HMRFWKmeansV2 d1_kmeans = new HMRFWKmeansV2(d1.data, d1.k, par1);
			d1_kmeans.cluster();
			d1.old_idx = d1.idx;
			...
			HMRFWKmeansV2 d2_kmeans = new HMRFWKmeansV2(d2.data, d2.k, par2);
			d2_kmeans.cluster();
			d2.old_idx = d2.idx;
